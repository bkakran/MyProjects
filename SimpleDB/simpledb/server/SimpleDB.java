...
public class SimpleDB {
   ...
   private static int correlated_reference_period = 10;
   ...
   public static int getKForLRU()     { return k; }
   public static int getCorelatedReferenePeriod()     { return correlated_reference_period; }
